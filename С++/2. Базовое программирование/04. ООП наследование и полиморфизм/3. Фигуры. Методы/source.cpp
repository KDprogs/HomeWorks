...
public:
	...
	bool check() override
	{
		if (Triangle::check() && get_a() == get_b() && get_b() == get_c() && get_A() == get_B() && get_B() == get_C()) { return true; }
		else { return false; }
	};
};
...
public:
	...
	bool check() override
	{
		if (Quadrangle::check() && get_a() == get_c() && get_b() == get_d() && get_A() == get_B() && get_B() == get_C() && get_C() == get_D()) { return true; }
		else { return false; }
	};
};
...
public:
	...
	bool check() override
	{
		if (Quadrangle::check() && get_a() == get_b() && get_b() == get_c() && get_c() == get_d() && get_A() == get_B() && get_B() == get_C() && get_C() == get_D()) { return true; }
		else { return false; }
	};
};
...
public:
	...
	bool check() override
	{
		if (Quadrangle::check() && get_a() == get_c() && get_b() == get_d() && get_A() == get_C() && get_B() == get_D()) { return true; }
		else { return false; }
	};
};
...
public:
	...
	bool check() override
	{
		if (Quadrangle::check() && get_a() == get_b() && get_b() == get_c() && get_c() == get_d() && get_A() == get_C() && get_B() == get_D()) { return true; }
		else { return false; }
	};
};
